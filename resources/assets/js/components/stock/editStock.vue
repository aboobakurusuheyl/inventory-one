			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">Stock Update</h4>
					</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="input-group">
										...
										<div class="form-line">
											...
											<input type="text" class="form-control" placeholder="Quantity " v-model="stock.current_quantity" disabled="">
										</div>
									</div>
								</div>		
								...
								<div class="col-md-6">
									<div class="input-group">
										...
										<div class="form-line">
											<p>Chalan No</p>
											<input  type="text" class="form-control" placeholder="Chalan No:" title="Chalan No" v-model="stock.chalan_no" disabled="">
										</div>
									</div>
								</div>			
					...
					<div class="modal-footer">
						<br>
						<button @click="updateStock(stock.id)" type="button" class="btn btn-success waves-effect">UPDATE</button>
