			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">Update Vendor Information</h4>
					</div>
					...
					<div class="modal-footer">
						<br>
						<button @click="updateVendor(vendor.id)" type="button" class="btn btn-success waves-effect">Update</button>
...
export default{
 ...
 methods : {
   ...
   editVendor(id){
    ...
    axios.get(base_url+'supplier/'+id+'/edit')
