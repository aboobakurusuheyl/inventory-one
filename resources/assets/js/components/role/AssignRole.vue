			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">Permission of <span style="color: teal">{{ role.role_name }}</span></h4>
					</div>
					...
					<div class="modal-footer">
						<br>
						<button @click="AssignRole" type="button" class="btn btn-success waves-effect">Update</button>
