			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">Update Category Information</h4>
					</div>
					...
					<div class="modal-footer">
						<br>
						<button @click="updatecategory(category.id)" type="button" class="btn btn-success waves-effect">Update</button>
