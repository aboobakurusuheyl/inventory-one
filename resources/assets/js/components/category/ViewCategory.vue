        			...
        			<tbody>
        				<tr v-for="(value,index) in categorys.data">
        					...
        					<td>
        						...
        						<button @click="editCategory(value.id)" type="button" class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
        						...
        						<button @click="deleteCategory(value.id)" type="button" class="btn bg-pink btn-circle waves-effect waves-circle waves-float">
        		...
        		<div class="text-center col-md-12" v-if="categorys.last_page > 1">
        			<ul class="pagination">
        				<li :class="[ ((categorys.current_page == 1) ? 'disabled' : '') ]">
        					<a :href="'?page='+categorys.current_page" @click.prevent="pageClicked(categorys.current_page-1)" aria-label="Previous" v-if="categorys.current_page != 1">
        			...
        			<li :class="[ ((categorys.current_page == categorys.last_page) ? 'disabled' : '') ]" >
        				<a  :href="'?page='+categorys.current_page" @click.prevent="pageClicked(categorys.current_page+1)" aria-label="Next" v-if="categorys.current_page != categorys.last_page">
        					<span aria-hidden="true">»</span>
        				</a>
        				<a v-else>
        					<span  aria-hidden="true">»</span>
